...
struct ContentView: View {
    ...
    @State private var editingItem: DevicepinvaultItem?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Kids Screen Password Vault")
            .toolbar {
...
struct AddEditView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(item == nil ? "Add Device" : "Edit Device")
            .toolbar {
